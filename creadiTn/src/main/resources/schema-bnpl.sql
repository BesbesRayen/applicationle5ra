...
CREATE TABLE IF NOT EXISTS purchase_orders (
    ...
    merchant_margin_rate DECIMAL(8,4) NOT NULL DEFAULT 0,
    merchant_payout_amount DECIMAL(12,2) NOT NULL DEFAULT 0,
    platform_profit_amount DECIMAL(12,2) NOT NULL DEFAULT 0,
